...
async function main() {
  ...
  if (sermonCount === 0) {
    ...
    console.log("Sermons de démo créés.");
  }

  const eventCount = await prisma.churchEvent.count();
  if (eventCount === 0) {
    ...
    console.log("Événements de démo créés.");
  }
  ...
  if (deptCount === 0) {
    await prisma.department.createMany({
      data: [
        { nameFr: "Chorale", nameEn: "Choir", descFr: "La louange et l'adoration par le chant.", descEn: "Praise and worship through singing.", sortOrder: 1 },
        { nameFr: "Jeunesse", nameEn: "Youth", descFr: "Encadrement et formation des jeunes.", descEn: "Supporting and discipling young people.", sortOrder: 2 },
        { nameFr: "Femmes", nameEn: "Women", descFr: "Épanouissement et soutien des femmes.", descEn: "Growth and support of women.", sortOrder: 3 },
        { nameFr: "Hommes", nameEn: "Men", descFr: "Fratrie et édification des hommes.", descEn: "Fellowship and edification of men.", sortOrder: 4 },
        { nameFr: "Enfants", nameEn: "Children", descFr: "École du dimanche pour les enfants.", descEn: "Sunday school for children.", sortOrder: 5 },
        { nameFr: "Évangélisation", nameEn: "Evangelism", descFr: "Témoigner et partager l'Évangile.", descEn: "Witnessing and sharing the Gospel.", sortOrder: 6 },
      ],
    });
    console.log("Départements de démo créés.");
  }
  ...
  if (scheduleCount === 0) {
    await prisma.scheduleItem.createMany({
      data: [
        { dayFr: "Dimanche", dayEn: "Sunday", time: "09h00 – 11h30", nameFr: "Culte de louange et d'adoration", nameEn: "Worship and praise service", sortOrder: 1 },
        { dayFr: "Mardi", dayEn: "Tuesday", time: "17h30 – 19h00", nameFr: "Étude biblique", nameEn: "Bible study", sortOrder: 2 },
        { dayFr: "Jeudi", dayEn: "Thursday", time: "18h00 – 19h30", nameFr: "Intercession et prière", nameEn: "Prayer and intercession", sortOrder: 3 },
        { dayFr: "Vendredi", dayEn: "Friday", time: "17h00 – 19h00", nameFr: "Répétition de la chorale", nameEn: "Choir rehearsal", sortOrder: 4 },
      ],
    });
    console.log("Horaires de démo créés.");
  }

  const donationCount = await prisma.donationInfo.count();
  if (donationCount === 0) {
    await prisma.donationInfo.createMany({
      data: [
    ...
    console.log("Donations de démo créées.");
  }
  ...
  if (settingsCount === 0) {
    await prisma.siteSetting.createMany({
      data: [
        { key: "address", valueFr: "Quartier Niamey 2000, Niamey, Niger", valueEn: "Niamey 2000 district, Niamey, Niger" },
    ...
    console.log("Paramètres de démo créés.");
  }
  ...
  if (galleryCount === 0) {
    ...
    console.log("Galerie de démo créée.");
  }

  console.log("Seed terminé (idempotent, aucune donnée supprimée).");
}
